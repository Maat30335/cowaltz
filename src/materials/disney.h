...
namespace Disney {
    ...
    Color EvaluateSpecBRDF(const PrincipledParameters &parameters, const Vector3f &wi, const Vector3f &wo, const Vector3f &wh, const Normal3f &n, double *pdf);
    Color EvaluateSpecTransmission(const PrincipledParameters &parameters, const Vector3f &wi, const Vector3f &wo, const Vector3f &wt, const Normal3f &n, double *pdf);
    ...
    Color EvaluateDisney(const SurfaceInteraction &isect, const Vector3f &wi, const Vector3f &wo, double *pdf);
};
